...
```
cd existing_repo
git remote add origin https://gitlab.com/obelisk02/node-code-verifier.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/obelisk02/node-code-verifier/-/settings/integrations)
